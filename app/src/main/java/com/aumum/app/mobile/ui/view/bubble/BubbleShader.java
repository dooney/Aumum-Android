...
public class BubbleShader extends ShaderHelper {
    ...
    private static final int DEFAULT_HEIGHT_DP = 7;
    ...
    public void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        arrowStartY = dpToPx(context.getResources().getDisplayMetrics(), 30);
    }
    ...
    public void calculate(int bitmapWidth, int bitmapHeight,
        ...
        float centerY  = Math.min(arrowStartY, resultHeight / 2f) + y;
