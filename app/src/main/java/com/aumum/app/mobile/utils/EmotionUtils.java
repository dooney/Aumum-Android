...
public class EmotionUtils {
    ...
    private static Map<String, String> general = new LinkedHashMap<String, String>();
    private static Map<String, String> huahua = new LinkedHashMap<String, String>();
    ...
    public static String getFromGeneral(String key) {
        return general.get(key);
    }

    public static String getFromHuaHua(String key) {
        return huahua.get(key);
    }
}
