...
public class UserVM extends BaseVM  {
    ...
    public UserVM(Long id) {
        this.id = id;
    }

    public UserVM(Long id, String objectId, java.util.Date createdAt, String screenName, Integer area, String avatarUrl, String about, String followers, String followings, String comments, String messages, String parties, String partyPosts, String moments, String momentPosts) {
        this.id = id;
    ...
    public List<String> getPartyList() {
        return getList(parties);
    }

    public List<String> getPartyPostList() {
        return getList(partyPosts);
    }
