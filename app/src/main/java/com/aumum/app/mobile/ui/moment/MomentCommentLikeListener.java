 ...
 */
public class MomentCommentLikeListener implements LikeTextView.OnLikeListener {
    ...
    public MomentCommentLikeListener(MomentComment comment) {
    ...
    public void onUnLike(LikeTextView view) {
        ...
        task = new SafeAsyncTask<Boolean>() {
            public Boolean call() throws Exception {
                ...
                restService.removeMomentCommentLike(comment.getObjectId(), currentUser.getObjectId());
                return true;
            }
    ...
    public void onLike(final LikeTextView view) {
        ...
        task = new SafeAsyncTask<Boolean>() {
            public Boolean call() throws Exception {
                User currentUser = userStore.getCurrentUser();
                restService.addMomentCommentLike(comment.getObjectId(), currentUser.getObjectId());
    ...
    private void sendLikeMessage(Context context, User currentUser) throws Exception {
        if (!comment.getUserId().equals(currentUser.getObjectId())) {
            String title = context.getString(R.string.label_like_moment_comment_message,
