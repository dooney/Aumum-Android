 ...
 */
public class SavingCommentCard implements ActionListener {
    ...
    public SavingCommentCard(View view) {
    ...
    public void refresh(SavingComment comment) {
        ...
        likeText.setLikeListener(new SavingCommentLikeListener(comment));
